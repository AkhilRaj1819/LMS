            ...
            <section className="content-section">
                ...
                <div className="bg-gradient-to-br from-slate-50 to-slate-100 border-2 border-slate-300 rounded-3xl p-10 shadow-xl">
                    ...
                    <svg viewBox="0 0 600 800" className="w-full h-auto">
                        ...
                        <text x="300" y="480" textAnchor="middle" fill="#374151" fontSize="12" fontWeight="600">such that xy<tspan baselineShift="super" fontSize="9">i</tspan>z ∉ L</text>
...
def verify_all_splits(lang_fn, s, p, max_i=20):
    ...
    ...`}
            ...
            <section className="content-section" id="quiz">
                <h3 className="text-2xl font-bold text-gray-900 mb-6">MCQ Practice</h3>
                <Quiz 
                    title="MCQ Practice: Proving Languages Not Regular"
                    subject="Theory of Computation"
                    unitId={2}
                    moduleId={3}
                    questions={[
                        {
                            question: "What is the primary purpose of the Pumping Lemma for regular languages?",
                            options: ["To prove a language is regular", "To prove a language is NOT regular", "To find the number of states in a DFA", "To minimize a DFA"],
                            correctAnswer: 1,
                            explanation: "The Pumping Lemma is a tool used to prove that a language is NOT regular by showing it cannot satisfy the lemma's conditions."
                        },
                        {
                            question: "Which theorem provides an 'if and only if' condition for regularity based on equivalence classes?",
                            options: ["Pumping Lemma", "Myhill-Nerode Theorem", "Arden's Theorem", "Kleene's Theorem"],
                            correctAnswer: 1,
                            explanation: "The Myhill-Nerode theorem characterizes regular languages by the finiteness of their equivalence classes."
                        },
                        {
                            question: "In the Pumping Lemma string decomposition w = xyz, which part must NOT be empty?",
                            options: ["x", "y", "z", "x and z"],
                            correctAnswer: 1,
                            explanation: "The pumping part 'y' must consist of at least one character (|y| > 0)."
                        },
                        {
                            question: "If a language L has infinitely many pairwise distinguishable strings, what can we conclude?",
                            options: ["L is regular", "L is finite", "L is NOT regular", "L is an empty language"],
                            correctAnswer: 2,
                            explanation: "By the Myhill-Nerode theorem, if L has infinitely many distinguishable strings, it must have infinitely many states, meaning it is not regular."
                        },
                        {
                            question: "Which of the following languages is NOT regular?",
                            options: ["{w | w starts with 0}", "{0ⁿ1ⁿ | n ≥ 0}", "{w | w has even number of 1s}", "(0|1)*"],
                            correctAnswer: 1,
                            explanation: "{0ⁿ1ⁿ | n ≥ 0} is a classic example of a non-regular language because it requires 'memory' to count the number of 0s to match with 1s."
                        }
                    ]}
                />
            </section>
