...
const Module1_1: React.FC = () => {
  const quizQuestions = [
    {
      question: "Which component of a formal proof system is accepted as true without proof?",
      options: ["Theorem", "Axiom", "Inference Rule", "Lemma"],
      correctAnswer: 1,
      explanation: "Axioms are the fundamental statements of a system that are accepted as true without needing any proof themselves."
    },
    {
      question: "In a proof by contradiction, what is the first step?",
      options: ["Assume the statement is true", "Assume the negation of the statement is true", "Prove the contrapositive", "Apply mathematical induction"],
      correctAnswer: 1,
      explanation: "Proof by contradiction begins by assuming the opposite (negation) of what you want to prove, eventually showing it leads to an impossibility."
    },
    {
      question: "Which logical rule allows you to conclude Q if you know P and P → Q?",
      options: ["Modus Tollens", "Modus Ponens", "Hypothetical Syllogism", "Disjunctive Syllogism"],
      correctAnswer: 1,
      explanation: "Modus Ponens is the 'method of affirming' which states that if P is true and P implies Q, then Q must be true."
    },
    {
      question: "To prove P ↔ Q (P if and only if Q), what must you show?",
      options: ["P → Q only", "Q → P only", "P → Q and Q → P", "¬P → ¬Q"],
      correctAnswer: 2,
      explanation: "A biconditional statement P ↔ Q requires proving the implication in both directions: P implies Q and Q implies P."
    },
    {
      question: "Mathematical induction is best suited for proving properties of:",
      options: ["Real numbers", "Natural numbers (0, 1, 2...)", "Complex numbers", "Irrational numbers"],
      correctAnswer: 1,
      explanation: "Induction is designed to prove statements about the set of natural numbers (or any well-ordered set) due to its discrete, step-by-step nature."
    }
  ];
...
if __name__ == "__main__":
    sum_formula_example()`}
      ...
      <section className="content-section mt-12 bg-slate-50 p-8 rounded-[3rem] border-2 border-slate-100">
        <h2 className="text-3xl font-black mb-8 text-center uppercase tracking-tighter italic">Module 1.1 Mastery Quiz</h2>
        <div className="bg-white p-6 rounded-xl border-2 border-slate-100 shadow-sm transition-all hover:shadow-md">
          <Quiz
            title="Introduction to Formal Proof Quiz"
      ...
      <div className="mt-16 py-8 border-t text-center opacity-30">
        <p className="text-[10px] font-black uppercase tracking-[1em]">Unit 1.1 | Module Complete</p>
      </div>
