              ...
              <div className="border-2 border-gray-300 rounded-lg p-4 bg-gray-50">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center gap-2">
                    <circle cx="10" cy="10" r="10" className="inline-block w-6 h-6 rounded-full bg-blue-500"/>
                    <span>Start State</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="relative inline-block">
                      <circle cx="10" cy="10" r="10" className="w-6 h-6 rounded-full bg-green-500"/>
                      <circle cx="10" cy="10" r="13" className="absolute top-0 left-0 w-6 h-6 rounded-full border-2 border-green-700"/>
                    </div>
        ...
        <div className="space-y-6 mt-4">
          <div className="bg-white border-2 border-gray-300 rounded-lg p-4">
            ...
            <div className="space-y-2">
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">A) NFAs can recognize more languages than DFAs</div>
              <div className="p-3 border rounded hover:bg-green-50 cursor-pointer bg-green-100 border-green-500">B) NFAs can have multiple transitions for the same state-symbol pair, while DFAs have exactly one</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">C) NFAs run faster than DFAs in practice</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">D) NFAs cannot have accepting states</div>
            </div>
            <details className="mt-4">
              ...
              <div className="mt-2 p-3 bg-green-50 border-l-4 border-green-500">
                ...
                <p className="text-sm mt-2">The key difference is in the transition function. In a DFA, δ: Q × Σ → Q maps to exactly one state. In an NFA, δ: Q × Σ → P(Q) maps to a set of states (power set). Both recognize the same class of languages (regular languages), so NFAs are not more powerful. DFAs are typically faster in practice due to deterministic execution.</p>
              </div>
            </details>
          </div>
          ...
          <div className="bg-white border-2 border-gray-300 rounded-lg p-4">
            ...
            <div className="space-y-2">
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">A) The entire NFA immediately rejects the input string</div>
              <div className="p-3 border rounded hover:bg-green-50 cursor-pointer bg-green-100 border-green-500">B) That particular computation path dies, but other parallel paths may continue</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">C) The NFA moves to a special error state</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">D) The NFA automatically accepts the string</div>
            </div>
            <details className="mt-4">
              <summary className="cursor-pointer text-blue-600 font-semibold">Check Answer</summary>
              <div className="mt-2 p-3 bg-green-50 border-l-4 border-green-500">
                <p className="font-semibold text-green-800">Correct Answer: B</p>
                <p className="text-sm mt-2">NFAs explore multiple computation paths in parallel. When δ(q, a) = ∅, only that specific path terminates (dies). Other parallel paths continue processing the input. The NFA accepts if at least one path reaches an accepting state. This is a crucial aspect of nondeterministic computation.</p>
              </div>
            </details>
          </div>
          ...
          <div className="bg-white border-2 border-gray-300 rounded-lg p-4">
            ...
            <div className="space-y-2">
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">A) To consume empty strings from the input</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">B) To make the NFA more powerful than DFAs</div>
              <div className="p-3 border rounded hover:bg-green-50 cursor-pointer bg-green-100 border-green-500">C) To allow state transitions without consuming any input symbol, simplifying NFA design</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">D) To represent syntax errors in the input</div>
            </div>
            <details className="mt-4">
              <summary className="cursor-pointer text-blue-600 font-semibold">Check Answer</summary>
              <div className="mt-2 p-3 bg-green-50 border-l-4 border-green-500">
                <p className="font-semibold text-green-800">Correct Answer: C</p>
                <p className="text-sm mt-2">Epsilon transitions allow the NFA to change states spontaneously without reading any input symbol. They don't make NFAs more powerful (ε-NFAs, NFAs, and DFAs all recognize regular languages), but they greatly simplify automaton design, especially when combining automata for union, concatenation, and Kleene star operations in regex-to-NFA conversion.</p>
              </div>
            </details>
          </div>
          ...
          <div className="bg-white border-2 border-gray-300 rounded-lg p-4">
            ...
            <div className="space-y-2">
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">A) n states (same as NFA)</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">B) n² states</div>
              <div className="p-3 border rounded hover:bg-green-50 cursor-pointer bg-green-100 border-green-500">C) 2ⁿ states (exponential)</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">D) n! states (factorial)</div>
            </div>
            <details className="mt-4">
              <summary className="cursor-pointer text-blue-600 font-semibold">Check Answer</summary>
              <div className="mt-2 p-3 bg-green-50 border-l-4 border-green-500">
                <p className="font-semibold text-green-800">Correct Answer: C</p>
                <p className="text-sm mt-2">During subset construction, each DFA state corresponds to a subset of NFA states. Since an n-element set has 2ⁿ subsets (the power set), the DFA can have up to 2ⁿ states. This exponential blowup is why NFAs are often preferred for representation despite DFAs being faster to execute. In practice, many DFA states may be unreachable, so the actual number is often much smaller.</p>
              </div>
            </details>
          </div>
          ...
          <div className="bg-white border-2 border-gray-300 rounded-lg p-4">
            ...
            <div className="space-y-2">
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">A) The set of states that can reach S via ε-transitions</div>
              <div className="p-3 border rounded hover:bg-green-50 cursor-pointer bg-green-100 border-green-500">B) All states reachable from S via zero or more ε-transitions, including S itself</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">C) The set of accepting states reachable from S</div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer">D) The states in S with ε-transitions removed</div>
            </div>
            <details className="mt-4">
              <summary className="cursor-pointer text-blue-600 font-semibold">Check Answer</summary>
              <div className="mt-2 p-3 bg-green-50 border-l-4 border-green-500">
                <p className="font-semibold text-green-800">Correct Answer: B</p>
                <p className="text-sm mt-2">The ε-closure (or epsilon closure) of a state set S is the set of all states reachable from any state in S by following zero or more ε-transitions. This includes all states in S itself. Computing ε-closure is essential for NFA simulation and subset construction algorithms. It's typically computed using depth-first search (DFS) or breadth-first search (BFS) following only ε-edges.</p>
              </div>
            </details>
          </div>
        </div>
